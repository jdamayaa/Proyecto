...
async def recolectar_valores():
    ...
    while True:
        ...
        hum = int((7000-(Lectura_Sensor_Humedad - 17000))*0.014)    #Se convierte lalectura del pin analogico de 16 bit a % de humedad
        ...
        temp = round(temp, 1)
        print(f"Lectura sensor humedad: {hum}, sensor temperatura: {temp} -------------------------")
...
#             #print("Hora sin actualizar con google")
        ...
        datosjson = (fecha_hora[:5], hum, temp, hum_set, temp_set)
