...
def mostrar_datos_pantalla():
    #print('ingresando a mostrar datos por pantalla')
    display.ClearScreenCursorHome()  
    display.WriteLine('Tc: A:'+str(hum)+' S:' + str(hum) ,1)
    display.WriteLine('H%: A:'+str(hum)+' S:' + str(hum) ,2)
...
def menu1_1_1():
    ...
    display.WriteLine(' Humedad: '+str(hum)+' C',2)
    display.CursorMayor(2)
    sleep(2)
...
def menu1_2_1():
    display.ClearScreenCursorHome() 
    display.WriteLine(' Valor deseado: ',1)
    display.WriteLine(' Temperatura: '+str(temp)+'% ',2)
    display.CursorMayor(2)
    sleep(2)
