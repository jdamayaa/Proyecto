...
def lectura_teclado():
    ...
    if pulsador_oprimido < 20000:
        opcion_teclado ="derecha"
    elif 20000 <= pulsador_oprimido < 25000:
        opcion_teclado ="arriba"
    elif 25000 <= pulsador_oprimido < 32500:
        opcion_teclado ="abajo"
    elif 32500 <= pulsador_oprimido < 42000:
        opcion_teclado ="izquierda"
    elif 42000 <= pulsador_oprimido < 52000:
