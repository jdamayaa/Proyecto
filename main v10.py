...
def conectar_red():
    ...
    for i in range(10):
        try:
            ...
            t = time.localtime(tiempo_actual)          # Se almacena la hora en la tupla hora  una tupla vacia se defini t = ()
            print('Tipo de la variable t= ',type(t))
            print('ultima hora: ', t)
            print()
...
async def main():
    #a.create_task(recolectar_valores())
    #await recolectar_valores()
    await conectar_red()
    #mensaje_inicio()
    #menu_ppal()
#    limpiar_datos_json()  #----------------------------------------------------------------------------------------------------------------------------
